...
> See also: `notes/avahi.md`, `notes/tailscale.md`
...
services.avahi = {
  ...
  publish = {
    enable = true;
    addresses = true;   # announce your own IP on LAN
    workstation = true;
  };
};
```
...
- [Tailscale — NixOS Wiki](https://wiki.nixos.org/wiki/Tailscale)
